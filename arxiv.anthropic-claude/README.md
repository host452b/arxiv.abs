...
Supervised fine-tuning (SFT)    InstructGPT / RLHF (2022)    Preference-based alignment
  ...
  └──────────────────────────────── ┘                             │
                                                                   │
Rule-based safety filters       Constitutional AI (2022)       Principle-guided self-critique
  │ keyword block lists              │ AI evaluates AI via rules     │ model internalizes guidelines
  └──────────────────────────────────┘                             │
                                                                   │
"Neural nets are black boxes"   Mechanistic interp (2022–)    Circuit-level understanding
  ...
  └──────────────────────────────────┘                             │
                                                                   │
Features map 1:1 to neurons     Superposition hypothesis       Polysemantic encoding
  │ one neuron = one concept         │ Elhage et al. (2022)          │ N features in <N dimensions
  └──────────────────────────────────┘
```
