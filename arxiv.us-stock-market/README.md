...
CAPM single-factor model        Fama-French (1992)            Multi-factor risk models
  ...
  └──────────────────────────────── ┘                             │
                                                                   │
Efficient Market Hypothesis     Shiller / behavioral finance   Factor premia + behavioral biases
  │ prices = all information         │ excess volatility puzzle      │ PEAD, momentum, value persist
  └──────────────────────────────────┘                             │
                                                                   │
Constant volatility (BS model)  GARCH / stochastic vol (1986+) Regime-switching volatility
  ...
  └──────────────────────────────────┘                             │
                                                                   │
Fundamental analysis only       Quant revolution (1980s–)     Systematic / factor investing
  │ DCF, P/E, analyst calls          │ Simons, Asness, Fama          │ risk premia harvesting
  └──────────────────────────────────┘
```
